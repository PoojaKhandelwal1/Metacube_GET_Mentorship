...
%> --%>
	<tr>
	<td align="center"><%-- <%=student.getFirst_name() %> <%=student.getLast_name() %> --%>Lname</td>
	<td align="center"><%-- <%=student.getFname() %> --%>Fname</td>
	<td align="center"><%-- <%=student.getEmail() %> --%>Email</td>
	<td align="center"><%-- <%=student.getClass_name() %> --%>ClassName</td>
