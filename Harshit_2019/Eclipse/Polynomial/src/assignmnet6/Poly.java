...
public final class Poly {
	...
	**/
	static final  void printPoly(int poly[], int n) { 
        for (int i = 0; i < n; i++) { 
	...
	**/
    static final int[] addPoly(int[]first,int[] second){
    ...
    static final int[] multiplyPoly(int[]first,int[] second){
    ...
    static final int degree(int [] first){
    	int ans= 0;
    ...
    static final double evaluate(int arr[],int value){
	...
	public static void main(String[] args) {
			...
			System.out.println("press 4 for multiply two polynomial");
			 int choice= input.nextInt();
						 ...
						 int size2=0;
					try{
						System.out.println("enter size of first poly");
						size1 = input.nextInt();
						System.out.println("enter size for second poly");
						size2 = input.nextInt();		
					  }
						...
						if(size1<= 0 || size2<=0){
							...
							System.out.println("enter cofficent of first poly");
							for(int i= 0;i< size1;i++){
							poly1[i] = input.nextInt();
						    }
							System.out.println("enter cofficent of second poly");
